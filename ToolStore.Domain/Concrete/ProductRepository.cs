...
namespace ToolStore.Domain.Concrete
{
    ...
    public class ProductRepository : IProductRepository
    {
        ...
        #region products initializer

        private readonly IEnumerable<Product> _products
            = new List<Product> //Sorry :(

            {
                new Product
                {
                    ...
                    Description =
                        "Bosch super mega concrete breaking double rotor drill. 360 In. Lbs of Max torque - has enough torque to drive most common fasteners and drill bits" +
                ...
                new Product
                {
                    ...
                    Description =
                        "1,5 kilogramms of clear steel and comfortable grip. A brand-new, unused, unopened, undamaged item in its original packaging (where packaging is applicable). " +
                ...
                new Product
                {
                    ...
                    Name = "Hand back saw",
                    Description =
                        "Almost half as powerful as its electric analogue. A brand-new, unused, unopened, undamaged item (including handmade items). See the seller's listing for full details.",
                    Price = 210M
                }
            };

        #endregion //Delete this sh*t

        public IEnumerable<Product> Products
        {
            get { return _products; } //Deal with dao
        }
    }
}